...
st.markdown('Previously declared eliminated in the US in 2000, [cases and outbreaks of measles](https://www.cdc.gov/measles/cases-outbreaks.html) continue to periodically occur across the US.')
